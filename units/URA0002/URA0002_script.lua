#****************************************************************************
#**  File     : /units/URA0002/URA0002_script.lua
#**
#**  Author: CDR Deadalus
#**
...
#**
#**  Summary  : Cybran Defense Drone Script
#**
    ...
    Weapons = { 
        MainGun = Class(CAAAutocannon) {        
            CreateProjectileAtMuzzle = function(self, Muzzle_L,Muzzle_R)
                ...
                local proj = CAAAutocannon.CreateProjectileAtMuzzle(self, Muzzle_L,Muzzle_R)
            end,
        }, 
    }, 
...
### File pathing and special paramiters called ########################### 
    ...
    BeamAfterBurner = '/effects/emitters/gunship_thruster_beam_02_emit.bp', 
    BeamCruise = '/effects/emitters/gunship_thruster_beam_02_emit.bp',
