#****************************************************************************
#**  File     : /units/UAA0002/UAA0002_script.lua
#**
#**  Author: CDR Deadalus
#**
...
#**
#**  Summary  : Seraphim Assault Drone Script
#**
    ...
    Weapons = { 
        MainGun = Class(SDFOhCannon) {        
            CreateProjectileAtMuzzle = function(self, Muzzle_L,Muzzle_R)
                ...
                local proj = SDFOhCannon.CreateProjectileAtMuzzle(self, Muzzle_L,Muzzle_R)
            end,
        }, 
    }, 
