#****************************************************************************
#**  File     : /units/URA0003/URA0003_script.lua
#**
#**  Author: CDR Deadalus
#**
...
#**
#**  Summary  : Cybran Assault Drone Script
#**
...
URA0003 = Class(CAirUnit) { 
    Weapons = { 
        MainGun = Class(CDFLaserPulseLightWeapon) {        
            CreateProjectileAtMuzzle = function(self, Muzzle_L01,Muzzle_L02,Muzzle_R01,Muzzle_R02)
                ...
                local proj = CDFLaserPulseLightWeapon.CreateProjectileAtMuzzle(self, Muzzle_L01,Muzzle_L02,Muzzle_R01,Muzzle_R02)
            end,
        }, 
    }, 
...
### File pathing and special paramiters called ########################### 
    ...
    ExhaustSmoke = '/effects/emitters/hydrocarbon_smoke_01_emit.bp',
