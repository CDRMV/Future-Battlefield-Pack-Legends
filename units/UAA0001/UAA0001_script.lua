#****************************************************************************
#**  File     : /units/UAA0001/UAA0001_script.lua
#**
#**  Author: CDR Deadalus
#**
...
#**
#**  Summary  : Aeon Defense Drone Script
#**
    ...
    Weapons = { 
        MainGun = Class(AAASonicPulseBatteryWeapon) {        
            CreateProjectileAtMuzzle = function(self, Muzzle_L,Muzzle_R)
                ...
                local proj = AAASonicPulseBatteryWeapon.CreateProjectileAtMuzzle(self, Muzzle_L,Muzzle_R)
            end,
        }, 
    }, 
...
### File pathing and special paramiters called ########################### 
    ...
    BeamAfterBurner = '/effects/emitters/adjacency_aeon_beam_01_emit.bp', 
    BeamCruise = '/effects/emitters/adjacency_aeon_beam_01_emit.bp',
    ExhaustSmoke = '/effects/emitters/energy_stream_01_emit.bp',
