#****************************************************************************
#**  File     : /units/XSA0001/XSA0001_script.lua
#**
#**  Author: CDR Deadalus
#**
...
#**
#**  Summary  : Seraphim Defense Drone Script
#**
...
XSA0001 = Class(CAirUnit) { 
    Weapons = { 
        MainGun = Class(SAAShleoCannonWeapon) {        
            CreateProjectileAtMuzzle = function(self, Muzzle_L,Muzzle_R)
                ...
                local proj = SAAShleoCannonWeapon.CreateProjectileAtMuzzle(self, Muzzle_L,Muzzle_R)
            end,
        }, 
    }, 
...
### File pathing and special paramiters called ########################### 
    ...
    BeamAfterBurner = '/effects/emitters/serpentine_missle_exhaust_beam_01_emit.bp', 
    BeamCruise = '/effects/emitters/serpentine_missle_exhaust_beam_01_emit.bp',
    ExhaustSmoke = '/effects/emitters/seraphim_airmoveexhaust_01_emit.bp',
...
########################################################################## 
    ...
    Afterburner = function(self) 
        if not self:IsDead() then 
            ...
            table.insert(self.BeamExhaustEffectsBag, CreateAttachedEmitter(self, 'Exhaust', self:GetArmy(), self.ExhaustSmoke):ScaleEmitter(0.25))
