...
URB2200 = Class(CStructureUnit) {
    Weapons = { 
        ...
        Launchbay_09 = Class(DroneWeapon) {},
        Launchbay_10 = Class(DroneWeapon) {},
        Launchbay_11 = Class(DroneWeapon) {},
        Launchbay_12 = Class(DroneWeapon) {},                                                                       
    }, 
...
LaunchBays = {
	    ...
	    'Launchbay_09','Launchbay_10','Launchbay_11','Launchbay_12',
             }, 
...
OnKilledUnit = function(self, unitKilled)
    CStructureUnit.OnKilledUnit(self, unitKilled)     
