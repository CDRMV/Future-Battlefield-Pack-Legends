#****************************************************************************
#**  File     : /units/UEA0005/UEA0005_script.lua
#**
#**  Author: CDR Deadalus
#**
...
#**
#**  Summary  : UEF Defense Drone Script
#**
...
UEA0005 = Class(CAirUnit) { 
    Weapons = { 
        MainGun = Class(TAirToAirLinkedRailgun) {        
            CreateProjectileAtMuzzle = function(self, Muzzle_L,Muzzle_R)
                ...
                local proj = TAirToAirLinkedRailgun.CreateProjectileAtMuzzle(self, Muzzle_L,Muzzle_R)
            end,
        }, 
    }, 
